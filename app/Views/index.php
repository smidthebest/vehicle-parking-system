...
<html lang ="en">
    ...
    <script>
        ...
        function addMarker(e){
          ...
          console.log(e); 
            mark.bindPopup("<button id=\"delete\" onclick=\"deletePoly("+ e[0] +","+ e[1] +")\">Delete</button>"); 
            markers.push(mark); 
        ...
        function deletePoly(e1, e2){
            ...
            if(polygon == null) return; 
                    ...
                    console.log(e1 , e2); 
                    for(var i = 0; i<markers.length; i++){
                        if(markers[i].getLatLng().lat == e1 && markers[i].getLatLng().lng == e2){
